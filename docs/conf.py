...
# -*- coding: utf-8 -*-
#
# RocketUnits documentation build configuration file, created by
...
version = '0.1.11'  # METADATA_RESET:version = '<<version>>'
# The full version, including alpha/beta/rc tags.
release = '0.1.11'  # METADATA_RESET:release = '<<version>>'
...
htmlhelp_basename = 'RocketUnitsdoc'
...
latex_documents = [
  (master_doc, 'RocketUnits.tex', u'RocketUnits Documentation',
...
man_pages = [
    (master_doc, 'projectabcxyz', u'RocketUnits Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'RocketUnits', u'RocketUnits Documentation',
   author, 'RocketUnits', 'One line description of project.',
   'Miscellaneous'),
]
